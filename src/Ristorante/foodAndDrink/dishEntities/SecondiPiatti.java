...
public class SecondiPiatti extends Portata {
     ...
     */
    public SecondiPiatti(Integer portataId, String name, Double price, boolean piattoDelGiorno, MenuTypeEnum tipoMenu) {
        super(portataId, TipoPortataEnum.SECONDI_PIATTI, name, price ,piattoDelGiorno, tipoMenu);
    }
}
